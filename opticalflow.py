...
from frame import files2frames, video2frames, frames_show, image_crop, images_crop, get_length, frames_downsample
...
def framesDir2flowsDir(sFrameBaseDir: str, sFlowBaseDir: str, nFramesNorm: int = None, sAlgorithm: str = "tvl1-fast"):
    ...
    for sFrameDir in liVideos:
        ...
        print("Video %5d: Calc optical flow with %s from %s frames to %s" % (
        nCounter, sAlgorithm, str(arFrames.shape), sFlowDir))
